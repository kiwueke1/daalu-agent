...
[04-deployment.md §1.7 — Running Daalu on Kubernetes](04-deployment.md#17-running-daalu-on-kubernetes).
...
> **NVIDIA Config Manager (NV-CM)** add-on provides one — install it via
> [04-deployment.md → Part 3](04-deployment.md#part-3-optional-network--server-management-nv-cm)
> and see [07-network-server-management.md](07-network-server-management.md) for using it.
